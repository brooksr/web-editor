...
export function Modal () {
    ...
    <div>
        ...
        <div id="usi_shadow" className="usi_hide_mobile"> </div>
        <div id="usi_container">
          <div className="usi_display">
            <Content />
          </div>
        </div>
    </div>
